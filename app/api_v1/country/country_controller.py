...
async def add_country_data(token: OAuthTokenDeps, country: CreateCountryDto = Body(...)):
    """
...
async def get_country_data(token: OAuthTokenDeps, id: str):
...
@router.put("/{id}")
async def update_country_data(token: OAuthTokenDeps, id: str, req: UpdateCountryDto = Body(...)):
    """
...
async def delete_country_data(token: OAuthTokenDeps, id: str):
