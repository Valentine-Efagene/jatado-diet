...
async def add_macro_nutrient_data(token: OAuthTokenDeps, macro_nutrient: CreateMacroNutrientDto = Body(...)):
    """
...
async def get_macro_nutrient_data(token: OAuthTokenDeps, id: str):
...
async def get_macro_nutrients(token: OAuthTokenDeps, params: ListQueryParams = Depends()):
...
@router.put("/{id}")
async def update_macro_nutrient_data(token: OAuthTokenDeps, id: str, req: UpdateMacroNutrientDto = Body(...)):
    """
...
async def delete_macro_nutrient_data(token: OAuthTokenDeps, id: str):
