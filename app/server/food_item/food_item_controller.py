...
async def add_food_item_data(food_item: CreateFoodItemDto = Body(...)):
    """
...
async def get_food_item_data(id):
...
@router.put("/{id}")
async def update_food_item_data(id: str, req: UpdateFoodItemDto = Body(...)):
    """
...
async def delete_food_item_data(id: str):
